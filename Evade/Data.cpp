...
namespace Evade
{
    ...
    void Data::InitSkillshots()
    {
        ...
        data.SkillshotName = "AniviaQCenter";
        data.IconName = "FlashFrost.png";
        data.SkillshotSlot = 'Q';
        data.Dangerous = true;
        data.FixedRange = true;
        ...
        data = SkillshotData();
        data.ChampionName = "Corki";
        data.DisplayName = "Missile Barrage [Big]";
        ...
        data.Damage = [](const StatData& info)
        {
            float base_scale[] = { 70, 85, 100, 115, 130 };
            float base_damage = base_scale[info.SpellLevel];
        ...
        data.MissileName = "EvelynnQ(?!Line)";
        ...
        data.DisplayName = "Boomerang Throw";
        data.MissileName = "GnarQMissile(?!Return)";
        ...
        data.Damage = [](const StatData& info)
        {
            float base_scale[] = { 80, 100, 120, 140, 160 };
            float base_damage = base_scale[info.SpellLevel];
            return base_damage + 0.25f * info.TotalAbilityDamage;
        };
        data.DamageType = DamageType::MAGICAL;
        ...
        data = SkillshotData();
        data.ChampionName = "Jinx";
        data.DisplayName = "Flame Chompers!";
        ...
        data.Damage = [](const StatData& info)
        {
            float base_scale[] = { 325, 475, 625 };
            float hp_scale[] = { 25.0f, 30.0f, 35.0f };
            float base_damage = base_scale[info.SpellLevel];
            float bonus_damage = 1.65f * info.BonusAttackDamage;
        ...
        data.FogSupport = true;
        data.Delay = 0.778f;
        data.ParticleDelay = 0.528f;
        data.ExtraTime = 0.231f;
        data.Radius = 200.0f;
        data.Range = 875.0f;
        data.DangerLevel = 1;
        data.Collisions = {};
        ...
        data.Damage = [](const StatData& info)
        {
            ...
            float base_damage = base_scale[info.SpellLevel];
            return base_damage + 0.2f * info.BonusAttackDamage;
        };
        data.DamageType = DamageType::PHYSICAL;
        data.SkillshotType = SkillshotType::CIRCLE;
        this->skillshots[data.SkillshotName] = data;
        ...
        data = SkillshotData();
        data.ChampionName = "Lux";
        data.DisplayName = "Light Strike Kugel";
        ...
        data.Damage = [](const StatData& info)
        {
            float base_scale[] = { 150, 250, 350 };
            float base_damage = base_scale[info.SpellLevel];
            return base_damage + 1.3f * info.TotalAbilityDamage;
        };
        data.DamageType = DamageType::MAGICAL;
        data.SkillshotType = SkillshotType::LINE;
        this->skillshots[data.SkillshotName] = data;
        ...
        data.IconName = "SmolderW.png"; // Check "Sweet"
        data.SkillshotSlot = 'W';
        data.AddHitbox = true;
        data.Dangerous = true;
        data.FixedRange = true;
        ...
        data.MissileName = "SmolderRMissile";
        ...
        data.Damage = [](const StatData& info)
        {
            float base_scale[] = { 125, 185, 245, 305, 365 };
            float base_damage = base_scale[info.SpellLevel];
            return base_damage + 0.8f * info.TotalAbilityDamage;
        };
        data.DamageType = DamageType::MAGICAL;
        ...
        data.MissileName = "SwainEReturn";
        data.SkillshotName = "SwainEReturn";
        data.IconName = "SwainE.png";
        data.SkillshotSlot = 'E';
        data.AddHitbox = true;
        data.BackToCaster = true;
        ...
        data.InitialSpeed = 600.0f;
        data.MinSpeed = 600.0f;
        data.MaxSpeed = 3000.0f;
        data.DangerLevel = 2;
        data.Collisions =
        {
        ...
        data.ParticleName = "_Q_aoe_gather";
        ...
        data.Damage = [](const StatData& info)
        {
            ...
            float ap_scale[] = { 70, 80, 90, 100, 110 };
            float base_damage = base_scale[info.SpellLevel];
            float bonus_damage = ap_scale[info.SpellLevel];
            bonus_damage *= info.TotalAbilityDamage / 100.0f;
            return base_damage + bonus_damage;
        ...
        data.MissileName = "VelkozQMissile";
        ...
        // Missing: Aatrox Q2, Akali Q, Akshan Q, Aurelion Sol R, Azir R,
        // Corki W, FiddleSticks E, Fizz E, Galio Q, Hecarim R, Illaoi Q,
        // Irelia E, LeeSin R, Lillia E, Lucian W, Pyke E, Rumble R,
        // Teemo R, Vi Q, Xayah E, Yuumi Q, Zac E, Zeri W, Zoe E
    }
